const Home = () => (
  <div className="portfolio-app">
    ...
    <div className="navbar-wrapper">
      <nav className="navbar navbar-expand-lg navbar-dark sm-mw9">
    ...
    <section className="sm-hero">
      <div className="sm-hero-wrapper row">
        <div className="hero-left col-md-6">
          <h1 className="white hero-title">
            Hey I'm Sean. Experienced full stack developer
          </h1>
    ...
    <div className="container">
        ...
        <div className="list-group">
          ...
          >
            ...
            <div className="avatar-container my-2">
              ...
              ></img>
              <span className="avatar-title">Sean Madzelonka</span>
            </div>
          </a>
          <a
            href="#"
      ...
      <section className="sm-category-list">
        <div className="row">
          <div className="col-md-4">
            <div className="sm-category-container">
              <a className="sm-category subtle-shadow no-border" href="#">
                {
                      ...
                      <div className="topic-header">
                        <div className="topic-meta">
                          <div className="name-container">
                            <span className="name">Sean Madzelonka</span>
                          </div>
